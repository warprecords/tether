...
var ZUI = function(two, surface) {
  ...
  this.add(new Surface(surface || two.scene));
...
_.extend(ZUI.prototype, {
  ...
  rotateSurface: function(rad) {
    ZUI.RotateMatrix(this.surfaceMatrix, rad);
    return this;
  },
